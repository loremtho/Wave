...
namespace Orangedkeys.UltimateDissolveFX
{
    public class WelcomeUltimateDissolveFX : EditorWindow
    {
        ...
        [MenuItem("Tools/OrangedKeys/UltimateDissolveFX Pack/About ", false, 0)]
        public static void ShowWindow()
        {
            EditorWindow editorWindow = GetWindow(typeof(WelcomeUltimateDissolveFX), false, " About ", true);
        ...
        private void OnGUI()
        {
            ...
            */
            ...
            // Add The Banner
            Texture2D welcomeImage = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/UltimateDissolve_FX/Resources/UltimateDissolveFX_GUI.png", typeof(Texture2D));
            ...
            EditorGUILayout.LabelField("Have fun with ''UltimateDissolve FX PACK'' !! \n", LargeTextStyle);
            EditorGUILayout.Space();
            ...
            EditorGUILayout.LabelField("Copyright © 2023 OrangedKeys", FooterTextStyle);
            GUILayout.EndArea();
        ...
        public void SendGFormData(string Useremail, string ownername)
        {
            ...
            string assetname = "UltimateDissolveFX,";
