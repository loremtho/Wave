...
Shader "ASE/ASE_StandartCutoutMoss"
{
	Properties
	{
		...
		[ASEEnd]_RimPower("RimPower", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_NormalMapDetail = packedInput.ase_texcoord5.xy * _NormalMapDetail_ST.xy + _NormalMapDetail_ST.zw;
				float3 unpack89 = UnpackNormalScale( tex2D( _NormalMapDetail, uv_NormalMapDetail ), _NormalMapDetailsDeep );
				unpack89.z = lerp( 1, unpack89.z, saturate(_NormalMapDetailsDeep) );
				float2 uv_NormalExtraDetails = packedInput.ase_texcoord5.xy * _NormalExtraDetails_ST.xy + _NormalExtraDetails_ST.zw;
				float3 unpack101 = UnpackNormalScale( tex2D( _NormalExtraDetails, uv_NormalExtraDetails ), _NormalExtraDetailsDeep );
				unpack101.z = lerp( 1, unpack101.z, saturate(_NormalExtraDetailsDeep) );
				float3 temp_output_100_0 = BlendNormal( BlendNormal( unpack13 , unpack89 ) , unpack101 );
				...
				float3 tanNormal75 = temp_output_100_0;
				float fresnelNdotV75 = dot( float3(dot(tanToWorld0,tanNormal75), dot(tanToWorld1,tanNormal75), dot(tanToWorld2,tanNormal75)), V );
				float fresnelNode75 = ( 0.0 + _RimScale * pow( 1.0 - fresnelNdotV75, _RimPower ) );
				float2 uv_RimmMask = packedInput.ase_texcoord5.xy * _RimmMask_ST.xy + _RimmMask_ST.zw;
				...
				float3 linearToGamma71 = FastLinearToSRGB( temp_cast_2 );
				...
				float3 linearToGamma72 = FastLinearToSRGB( temp_cast_6 );
				float3 temp_cast_7 = (tex2DNode5.a).xxx;
				float3 temp_cast_8 = (tex2D( _SmoothnessMap, uv_SmoothnessMap ).r).xxx;
				
				surfaceDescription.BaseColor = lerpResult94.rgb;
				surfaceDescription.Normal = temp_output_100_0;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = ( _Metallic * linearToGamma71 ).x;
				...
				surfaceDescription.Smoothness = ( (( _SmoothRough )?( ( 1.0 - (( _SmoothFromMapSwitch )?( linearToGamma72 ):( temp_cast_7 )) ) ):( (( _SmoothFromMapSwitch )?( linearToGamma72 ):( temp_cast_4 )) )) * _Snoothness ).x;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 unpack13 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), _NormalMapDepth );
				unpack13.z = lerp( 1, unpack13.z, saturate(_NormalMapDepth) );
				float2 uv_NormalMapDetail = packedInput.ase_texcoord2.xy * _NormalMapDetail_ST.xy + _NormalMapDetail_ST.zw;
				float3 unpack89 = UnpackNormalScale( tex2D( _NormalMapDetail, uv_NormalMapDetail ), _NormalMapDetailsDeep );
				unpack89.z = lerp( 1, unpack89.z, saturate(_NormalMapDetailsDeep) );
				float2 uv_NormalExtraDetails = packedInput.ase_texcoord2.xy * _NormalExtraDetails_ST.xy + _NormalExtraDetails_ST.zw;
				float3 unpack101 = UnpackNormalScale( tex2D( _NormalExtraDetails, uv_NormalExtraDetails ), _NormalExtraDetailsDeep );
				unpack101.z = lerp( 1, unpack101.z, saturate(_NormalExtraDetailsDeep) );
				float3 temp_output_100_0 = BlendNormal( BlendNormal( unpack13 , unpack89 ) , unpack101 );
				...
				float3 tanNormal75 = temp_output_100_0;
				float fresnelNdotV75 = dot( float3(dot(tanToWorld0,tanNormal75), dot(tanToWorld1,tanNormal75), dot(tanToWorld2,tanNormal75)), ase_worldViewDir );
				float fresnelNode75 = ( 0.0 + _RimScale * pow( 1.0 - fresnelNdotV75, _RimPower ) );
				float2 uv_RimmMask = packedInput.ase_texcoord2.xy * _RimmMask_ST.xy + _RimmMask_ST.zw;
				float4 blendOpSrc96 = temp_output_3_0;
				float4 blendOpDest96 = ( ( _RimColor * fresnelNode75 ) * tex2D( _RimmMask, uv_RimmMask ) );
				float4 temp_output_96_0 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc96 ) * ( 1.0 - blendOpDest96 ) ) ));
		...
		Pass
		{
					...
					)
			{
				...
				float3 unpack13 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), _NormalMapDepth );
				unpack13.z = lerp( 1, unpack13.z, saturate(_NormalMapDepth) );
				float2 uv_NormalMapDetail = packedInput.ase_texcoord3.xy * _NormalMapDetail_ST.xy + _NormalMapDetail_ST.zw;
				float3 unpack89 = UnpackNormalScale( tex2D( _NormalMapDetail, uv_NormalMapDetail ), _NormalMapDetailsDeep );
				unpack89.z = lerp( 1, unpack89.z, saturate(_NormalMapDetailsDeep) );
				float2 uv_NormalExtraDetails = packedInput.ase_texcoord3.xy * _NormalExtraDetails_ST.xy + _NormalExtraDetails_ST.zw;
				float3 unpack101 = UnpackNormalScale( tex2D( _NormalExtraDetails, uv_NormalExtraDetails ), _NormalExtraDetailsDeep );
				unpack101.z = lerp( 1, unpack101.z, saturate(_NormalExtraDetailsDeep) );
				float3 temp_output_100_0 = BlendNormal( BlendNormal( unpack13 , unpack89 ) , unpack101 );
				...
				float4 tex2DNode5 = tex2D( _MetallicMap, uv_MetallicMap );
				float3 temp_cast_0 = (tex2DNode5.a).xxx;
				float2 uv_SmoothnessMap = packedInput.ase_texcoord3.xy * _SmoothnessMap_ST.xy + _SmoothnessMap_ST.zw;
				float3 temp_cast_1 = (tex2D( _SmoothnessMap, uv_SmoothnessMap ).r).xxx;
				float3 temp_cast_2 = (tex2D( _SmoothnessMap, uv_SmoothnessMap ).r).xxx;
				float3 linearToGamma72 = FastLinearToSRGB( temp_cast_2 );
				float3 temp_cast_3 = (tex2DNode5.a).xxx;
				float3 temp_cast_4 = (tex2D( _SmoothnessMap, uv_SmoothnessMap ).r).xxx;
				
				float2 uv_Albedo = packedInput.ase_texcoord3.xy * _Albedo_ST.xy + _Albedo_ST.zw;
				float4 tex2DNode1 = tex2D( _Albedo, uv_Albedo );
				
				surfaceDescription.Normal = temp_output_100_0;
				surfaceDescription.Smoothness = ( (( _SmoothRough )?( ( 1.0 - (( _SmoothFromMapSwitch )?( linearToGamma72 ):( temp_cast_3 )) ) ):( (( _SmoothFromMapSwitch )?( linearToGamma72 ):( temp_cast_0 )) )) * _Snoothness ).x;
				surfaceDescription.Alpha = tex2DNode1.a;
		...
		Pass
		{
						...
						)
			{
				...
				float3 unpack13 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap ), _NormalMapDepth );
				unpack13.z = lerp( 1, unpack13.z, saturate(_NormalMapDepth) );
				float2 uv_NormalMapDetail = packedInput.ase_texcoord7.xy * _NormalMapDetail_ST.xy + _NormalMapDetail_ST.zw;
				float3 unpack89 = UnpackNormalScale( tex2D( _NormalMapDetail, uv_NormalMapDetail ), _NormalMapDetailsDeep );
				unpack89.z = lerp( 1, unpack89.z, saturate(_NormalMapDetailsDeep) );
				float2 uv_NormalExtraDetails = packedInput.ase_texcoord7.xy * _NormalExtraDetails_ST.xy + _NormalExtraDetails_ST.zw;
				float3 unpack101 = UnpackNormalScale( tex2D( _NormalExtraDetails, uv_NormalExtraDetails ), _NormalExtraDetailsDeep );
				unpack101.z = lerp( 1, unpack101.z, saturate(_NormalExtraDetailsDeep) );
				float3 temp_output_100_0 = BlendNormal( BlendNormal( unpack13 , unpack89 ) , unpack101 );
				...
				float fresnelNdotV75 = dot( float3(dot(tanToWorld0,tanNormal75), dot(tanToWorld1,tanNormal75), dot(tanToWorld2,tanNormal75)), V );
				float fresnelNode75 = ( 0.0 + _RimScale * pow( 1.0 - fresnelNdotV75, _RimPower ) );
				float2 uv_RimmMask = packedInput.ase_texcoord7.xy * _RimmMask_ST.xy + _RimmMask_ST.zw;
				float4 blendOpSrc96 = temp_output_3_0;
				float4 blendOpDest96 = ( ( _RimColor * fresnelNode75 ) * tex2D( _RimmMask, uv_RimmMask ) );
				float4 temp_output_96_0 = ( saturate( ( 1.0 - ( 1.0 - blendOpSrc96 ) * ( 1.0 - blendOpDest96 ) ) ));
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.RangedFloatNode;91;-1706.016,-279.9868;Float;False;Property;_NormalMapDetailsDeep;NormalMapDetailsDeep;18;0;Create;True;0;0;0;False;0;False;1;1.13;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;66;-1683.562,-553.7606;Float;False;Property;_NormalMapDepth;NormalMapDepth;17;0;Create;True;0;0;0;False;0;False;1;0.95;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;13;-1272.402,-610.6142;Inherit;True;Property;_NormalMap;NormalMap;7;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;102;-1502.48,-131.3913;Float;False;Property;_NormalExtraDetailsDeep;NormalExtraDetailsDeep;19;0;Create;True;0;0;0;False;0;False;1;0.75;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;89;-1304.663,-380.1685;Inherit;True;Property;_NormalMapDetail;NormalMapDetail;8;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;101;-1030.48,-203.3913;Inherit;True;Property;_NormalExtraDetails;NormalExtraDetails;9;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;74;-953.2848,-1145.992;Float;False;Property;_RimScale;RimScale;21;0;Create;True;0;0;0;False;0;False;1;1.33;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;78;-786.3458,-1593.323;Float;False;Property;_RimColor;RimColor;20;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.9317506,0.9433962,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;73;-950.7683,-1071.841;Float;False;Property;_RimPower;RimPower;23;0;Create;True;0;0;0;False;0;False;1;0.76;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;6;-1493.196,239.5266;Inherit;True;Property;_SmoothnessMap;SmoothnessMap;13;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;5;-1512.996,6.426482;Inherit;True;Property;_MetallicMap;MetallicMap;14;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;99;-319.5988,-1809.362;Inherit;True;Property;_RimmMask;RimmMask;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;4;-407.9034,-673.7851;Float;False;Property;_AlbedoColor;AlbedoColor;3;0;Create;True;0;0;0;False;0;False;1,1,1,1;0.7263656,0.8018868,0.4425505,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;2;-896.6956,186.1265;Float;False;Property;_SmoothFromMapSwitch;SmoothFromMapSwitch;10;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;92;80.56796,-1756.301;Inherit;True;Property;_AlbedoDetail;AlbedoDetail;2;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;95;-88.14692,-662.0649;Float;False;Property;_AlbedoDetailStrenth;AlbedoDetailStrenth;22;0;Create;True;0;0;0;False;0;False;1;0.72;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;11;-508.8754,175.1064;Float;False;Property;_SmoothRough;Smooth/Rough;12;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;9;-461.2012,333.9779;Float;False;Property;_Snoothness;Snoothness;15;0;Create;True;0;0;0;False;0;False;1;0.17;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;8;-644.9746,-14.00033;Float;False;Property;_Metallic;Metallic;16;0;Create;True;0;0;0;False;0;False;1;0.66;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;32;326.8384,-440.6982;Float;False;Property;_EmissionSwitch;EmissionSwitch;11;0;Create;True;0;0;0;False;0;False;0;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;420.8224,-589.8196;Float;False;Property;_EmissionMultiplayer;EmissionMultiplayer;6;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;36;820.1939,-986.7106;Float;False;Property;_EmissionColor;EmissionColor;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;111;4;7;0
WireConnection;111;7;10;0
WireConnection;111;9;1;4
ASEEND*/
//CHKSM=635D9DC4D26458525702B1D7C58DA1B2CA899E37