...
Shader "ASE/ASE_StandartSnow"
{
	Properties
	{
		...
		_SnowContrast("SnowContrast", Float) = 9.75
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_SnowTexture = packedInput.ase_texcoord5.xy * _SnowTexture_ST.xy + _SnowTexture_ST.zw;
				...
				float3 tanNormal107 = tex2DNode13;
				float3 worldNormal107 = float3(dot(tanToWorld0,tanNormal107), dot(tanToWorld1,tanNormal107), dot(tanToWorld2,tanNormal107));
				float temp_output_112_0 = pow( worldNormal107.y , _SnowPower );
				float4 temp_cast_0 = (temp_output_112_0).xxxx;
				float clampResult121 = clamp( (CalculateContrast(_SnowContrast,temp_cast_0)).r , 0.0 , 1.0 );
				...
				surfaceDescription.BaseColor = lerpResult124.rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 temp_output_3_0 = ( tex2D( _Albedo, uv_Albedo ) * _AlbedoColor );
				float2 uv_SnowTexture = packedInput.ase_texcoord2.xy * _SnowTexture_ST.xy + _SnowTexture_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				float4 temp_output_3_0 = ( tex2D( _Albedo, uv_Albedo ) * _AlbedoColor );
				float2 uv_SnowTexture = packedInput.ase_texcoord7.xy * _SnowTexture_ST.xy + _SnowTexture_ST.zw;
...
Node;AmplifyShaderEditor.WireNode;108;-891.0557,-1435.757;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;3;-43.04551,-749.0096;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WorldNormalVector;107;780.9219,-1527.893;Inherit;True;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;34;97.69397,-518.8632;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;32;319.2034,-471.3975;Float;False;Property;_EmissionSwitch;EmissionSwitch;10;0;Create;True;0;0;0;False;0;False;0;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;382.6343,-623.7619;Float;False;Property;_EmissionMultiplayer;EmissionMultiplayer;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;36;407.8217,-871.9639;Float;False;Property;_EmissionColor;EmissionColor;4;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ClampOpNode;121;1690.533,-1015.512;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;9;-461.2012,333.9779;Float;False;Property;_Snoothness;Snoothness;14;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;124;1339.022,-848.3568;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;37;926.7605,-546.6565;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;125;4;7;0
WireConnection;125;6;37;0
WireConnection;125;7;10;0
WireConnection;119;0;107;2
WireConnection;119;1;113;0
WireConnection;112;0;107;2
WireConnection;112;1;113;0
WireConnection;137;0;112;0
WireConnection;139;1;112;0
WireConnection;139;0;136;0
WireConnection;140;0;139;0
ASEEND*/
//CHKSM=FBC6F5B498E2D1C60E7D8FBA3B018AB8A11CA6D7