...
Shader "ASE/ASE_StandartVD"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _RedMultiplayer;
			float _RedOpacity;
			float _VertexColorStrenth;
			float _BlueOpacity;
			float _BlueMultiplayer;
						...
						)
			{
				...
				float2 uv_BlueTexture = packedInput.ase_texcoord5.xyz.xy * _BlueTexture_ST.xy + _BlueTexture_ST.zw;
				float4 temp_output_137_0 = ( tex2D( _BlueTexture, uv_BlueTexture ) * _BlueMultiplayer );
				float2 uv_Albedo = packedInput.ase_texcoord5.xyz.xy * _Albedo_ST.xy + _Albedo_ST.zw;
				float4 temp_output_3_0 = ( tex2D( _Albedo, uv_Albedo ) * _AlbedoColor );
				float2 uv_NormalMap = packedInput.ase_texcoord5.xyz.xy * _NormalMap_ST.xy + _NormalMap_ST.zw;
				...
				float3 worldRefl69 = reflect( -V, float3( dot( tanToWorld0, tex2DNode13 ), dot( tanToWorld1, tex2DNode13 ), dot( tanToWorld2, tex2DNode13 ) ) );
				float2 uv_MetallicMap = packedInput.ase_texcoord5.xyz.xy * _MetallicMap_ST.xy + _MetallicMap_ST.zw;
				float4 tex2DNode5 = tex2D( _MetallicMap, uv_MetallicMap );
				float2 uv_SmoothnessMap = packedInput.ase_texcoord5.xyz.xy * _SmoothnessMap_ST.xy + _SmoothnessMap_ST.zw;
				...
				float2 uv_RedTexture = packedInput.ase_texcoord5.xyz.xy * _RedTexture_ST.xy + _RedTexture_ST.zw;
				float2 uv_RedMask = packedInput.ase_texcoord5.xyz.xy * _RedMask_ST.xy + _RedMask_ST.zw;
				float clampResult124 = clamp( ( packedInput.ase_color.r + ( packedInput.ase_color.r * tex2D( _RedMask, uv_RedMask ).r ) ) , 0.0 , 1.0 );
				...
				float2 uv_BlueMask = packedInput.ase_texcoord5.xyz.xy * _BlueMask_ST.xy + _BlueMask_ST.zw;
				float clampResult132 = clamp( ( packedInput.ase_color.b + ( tex2D( _BlueMask, uv_BlueMask ).r * packedInput.ase_color.b ) ) , 0.0 , 1.0 );
				...
				float2 uv_RedNormals = packedInput.ase_texcoord5.xyz.xy * _RedNormals_ST.xy + _RedNormals_ST.zw;
				float3 lerpResult144 = lerp( tex2DNode13 , BlendNormal( tex2DNode13 , UnpackNormalScale( tex2D( _RedNormals, uv_RedNormals ), 1.0f ) ) , temp_output_126_0);
				...
				surfaceDescription.BaseColor = ( saturate( lerpBlendMode145 )).rgb;
				surfaceDescription.Normal = lerpResult144;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = temp_output_7_0;
				...
				surfaceDescription.Smoothness = temp_output_10_0;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_BlueTexture = packedInput.ase_texcoord2.xyz.xy * _BlueTexture_ST.xy + _BlueTexture_ST.zw;
				float4 temp_output_137_0 = ( tex2D( _BlueTexture, uv_BlueTexture ) * _BlueMultiplayer );
				float2 uv_Albedo = packedInput.ase_texcoord2.xyz.xy * _Albedo_ST.xy + _Albedo_ST.zw;
				float4 temp_output_3_0 = ( tex2D( _Albedo, uv_Albedo ) * _AlbedoColor );
				...
				float2 uv_MetallicMap = packedInput.ase_texcoord2.xyz.xy * _MetallicMap_ST.xy + _MetallicMap_ST.zw;
				float4 tex2DNode5 = tex2D( _MetallicMap, uv_MetallicMap );
				float2 uv_SmoothnessMap = packedInput.ase_texcoord2.xyz.xy * _SmoothnessMap_ST.xy + _SmoothnessMap_ST.zw;
				float3 linearToGamma103 = FastLinearToSRGB( tex2D( _SmoothnessMap, uv_SmoothnessMap ).rgb );
				float temp_output_10_0 = ( (( _SmoothRough )?( ( 1.0 - (( _SmoothFromMapSwitch )?( linearToGamma103.z ):( tex2DNode5.a )) ) ):( (( _SmoothFromMapSwitch )?( linearToGamma103.z ):( tex2DNode5.a )) )) * _Snoothness );
				float4 lerpResult87 = lerp( texCUBE( _CubemapBlured, worldRefl69 ) , texCUBE( _Cubmap, worldRefl69 ) , temp_output_10_0);
				float4 temp_output_71_0 = ( lerpResult87 * _CubemapColor );
				...
				float temp_output_7_0 = ( _Metallic * lerpResult93 );
				float4 lerpResult90 = lerp( ( temp_output_71_0 * saturate( temp_output_10_0 ) ) , ( temp_output_71_0 * temp_output_3_0 ) , temp_output_7_0);
				float2 uv_RedTexture = packedInput.ase_texcoord2.xyz.xy * _RedTexture_ST.xy + _RedTexture_ST.zw;
				float2 uv_RedMask = packedInput.ase_texcoord2.xyz.xy * _RedMask_ST.xy + _RedMask_ST.zw;
				float clampResult124 = clamp( ( packedInput.ase_color.r + ( packedInput.ase_color.r * tex2D( _RedMask, uv_RedMask ).r ) ) , 0.0 , 1.0 );
				float temp_output_126_0 = ( _RedOpacity * pow( clampResult124 , _VertexColorStrenth ) );
				float4 lerpResult114 = lerp( ( temp_output_3_0 + lerpResult90 ) , ( tex2D( _RedTexture, uv_RedTexture ) * _RedMultiplayer ) , temp_output_126_0);
				float4 blendOpSrc145 = temp_output_137_0;
				float4 blendOpDest145 = lerpResult114;
				float2 uv_BlueMask = packedInput.ase_texcoord2.xyz.xy * _BlueMask_ST.xy + _BlueMask_ST.zw;
				float clampResult132 = clamp( ( packedInput.ase_color.b + ( tex2D( _BlueMask, uv_BlueMask ).r * packedInput.ase_color.b ) ) , 0.0 , 1.0 );
				float temp_output_134_0 = ( pow( clampResult132 , _VertexColorStrenth ) * _BlueOpacity );
				float4 lerpBlendMode145 = lerp(blendOpDest145,(( blendOpDest145 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest145 ) * ( 1.0 - blendOpSrc145 ) ) : ( 2.0 * blendOpDest145 * blendOpSrc145 ) ),temp_output_134_0);
				
				float2 uv_RedNormals = packedInput.ase_texcoord2.xyz.xy * _RedNormals_ST.xy + _RedNormals_ST.zw;
				float3 lerpResult144 = lerp( tex2DNode13 , BlendNormal( tex2DNode13 , UnpackNormalScale( tex2D( _RedNormals, uv_RedNormals ), 1.0f ) ) , temp_output_126_0);
				
				float2 uv_EmissionMap = packedInput.ase_texcoord2.xyz.xy * _EmissionMap_ST.xy + _EmissionMap_ST.zw;
				float4 tex2DNode33 = tex2D( _EmissionMap, uv_EmissionMap );
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_RedMask = packedInput.ase_texcoord3.xy * _RedMask_ST.xy + _RedMask_ST.zw;
				float clampResult124 = clamp( ( packedInput.ase_color.r + ( packedInput.ase_color.r * tex2D( _RedMask, uv_RedMask ).r ) ) , 0.0 , 1.0 );
				float temp_output_126_0 = ( _RedOpacity * pow( clampResult124 , _VertexColorStrenth ) );
				float3 lerpResult144 = lerp( tex2DNode13 , BlendNormal( tex2DNode13 , UnpackNormalScale( tex2D( _RedNormals, uv_RedNormals ), 1.0f ) ) , temp_output_126_0);
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_BlueTexture = packedInput.ase_texcoord7.xyz.xy * _BlueTexture_ST.xy + _BlueTexture_ST.zw;
				float4 temp_output_137_0 = ( tex2D( _BlueTexture, uv_BlueTexture ) * _BlueMultiplayer );
				float2 uv_Albedo = packedInput.ase_texcoord7.xyz.xy * _Albedo_ST.xy + _Albedo_ST.zw;
				float4 temp_output_3_0 = ( tex2D( _Albedo, uv_Albedo ) * _AlbedoColor );
				...
				float3 tanToWorld2 = float3( tangentWS.xyz.z, ase_worldBitangent.z, normalWS.z );
				float3 worldRefl69 = reflect( -V, float3( dot( tanToWorld0, tex2DNode13 ), dot( tanToWorld1, tex2DNode13 ), dot( tanToWorld2, tex2DNode13 ) ) );
				float2 uv_MetallicMap = packedInput.ase_texcoord7.xyz.xy * _MetallicMap_ST.xy + _MetallicMap_ST.zw;
				float4 tex2DNode5 = tex2D( _MetallicMap, uv_MetallicMap );
				float2 uv_SmoothnessMap = packedInput.ase_texcoord7.xyz.xy * _SmoothnessMap_ST.xy + _SmoothnessMap_ST.zw;
				float3 linearToGamma103 = FastLinearToSRGB( tex2D( _SmoothnessMap, uv_SmoothnessMap ).rgb );
				float temp_output_10_0 = ( (( _SmoothRough )?( ( 1.0 - (( _SmoothFromMapSwitch )?( linearToGamma103.z ):( tex2DNode5.a )) ) ):( (( _SmoothFromMapSwitch )?( linearToGamma103.z ):( tex2DNode5.a )) )) * _Snoothness );
				float4 lerpResult87 = lerp( texCUBE( _CubemapBlured, worldRefl69 ) , texCUBE( _Cubmap, worldRefl69 ) , temp_output_10_0);
				float4 temp_output_71_0 = ( lerpResult87 * _CubemapColor );
				...
				float temp_output_7_0 = ( _Metallic * lerpResult93 );
				float4 lerpResult90 = lerp( ( temp_output_71_0 * saturate( temp_output_10_0 ) ) , ( temp_output_71_0 * temp_output_3_0 ) , temp_output_7_0);
				float2 uv_RedTexture = packedInput.ase_texcoord7.xyz.xy * _RedTexture_ST.xy + _RedTexture_ST.zw;
				float2 uv_RedMask = packedInput.ase_texcoord7.xyz.xy * _RedMask_ST.xy + _RedMask_ST.zw;
				float clampResult124 = clamp( ( packedInput.ase_color.r + ( packedInput.ase_color.r * tex2D( _RedMask, uv_RedMask ).r ) ) , 0.0 , 1.0 );
				float temp_output_126_0 = ( _RedOpacity * pow( clampResult124 , _VertexColorStrenth ) );
				float4 lerpResult114 = lerp( ( temp_output_3_0 + lerpResult90 ) , ( tex2D( _RedTexture, uv_RedTexture ) * _RedMultiplayer ) , temp_output_126_0);
				float4 blendOpSrc145 = temp_output_137_0;
				float4 blendOpDest145 = lerpResult114;
				float2 uv_BlueMask = packedInput.ase_texcoord7.xyz.xy * _BlueMask_ST.xy + _BlueMask_ST.zw;
				float clampResult132 = clamp( ( packedInput.ase_color.b + ( tex2D( _BlueMask, uv_BlueMask ).r * packedInput.ase_color.b ) ) , 0.0 , 1.0 );
				float temp_output_134_0 = ( pow( clampResult132 , _VertexColorStrenth ) * _BlueOpacity );
				float4 lerpBlendMode145 = lerp(blendOpDest145,(( blendOpDest145 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest145 ) * ( 1.0 - blendOpSrc145 ) ) : ( 2.0 * blendOpDest145 * blendOpSrc145 ) ),temp_output_134_0);
				
				float2 uv_RedNormals = packedInput.ase_texcoord7.xyz.xy * _RedNormals_ST.xy + _RedNormals_ST.zw;
				float3 lerpResult144 = lerp( tex2DNode13 , BlendNormal( tex2DNode13 , UnpackNormalScale( tex2D( _RedNormals, uv_RedNormals ), 1.0f ) ) , temp_output_126_0);
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.SamplerNode;6;-1961.9,260.7534;Inherit;True;Property;_SmoothnessMap;SmoothnessMap;22;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LinearToGammaNode;103;-1611.315,288.9816;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;5;-1775.516,-38.90791;Inherit;True;Property;_MetallicMap;MetallicMap;23;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;2;-1130.743,191.3664;Float;False;Property;_SmoothFromMapSwitch;SmoothFromMapSwitch;19;0;Create;True;0;0;0;False;0;False;1;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;66;-1536.795,-552.9112;Float;False;Property;_NormalMapDepth;NormalMapDepth;26;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;12;-750.9462,311.9731;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;13;435.9743,346.0193;Inherit;True;Property;_NormalMap;NormalMap;18;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;11;-515.8754,163.1064;Float;False;Property;_SmoothRough;Smooth/Rough;21;0;Create;True;0;0;0;False;0;False;0;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;9;-461.2012,333.9779;Float;False;Property;_Snoothness;Snoothness;24;0;Create;True;0;0;0;False;0;False;1;0.66;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.VertexColorNode;107;874.6304,-1462.761;Inherit;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;115;820.2333,-1758.987;Inherit;True;Property;_RedMask;RedMask;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LinearToGammaNode;105;-1487.305,24.36759;Inherit;False;0;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;4;-469.1862,-579.3098;Float;False;Property;_AlbedoColor;AlbedoColor;10;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;125;1545.633,-1154.487;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;95;-1387.871,-249.1329;Float;False;Property;_MetalicBrightnes;MetalicBrightnes;27;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;129;1216.324,-691.377;Inherit;True;Property;_BlueMask;BlueMask;4;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;1;-483.455,-819.0295;Inherit;True;Property;_Albedo;Albedo;8;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;130;1560.223,-459.6972;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;8;-644.9746,-14.00033;Float;False;Property;_Metallic;Metallic;25;0;Create;True;0;0;0;False;0;False;1;0.27;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;118;1787.433,-1242.886;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;3;-14.28024,-832.3592;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;131;1833.532,-461.507;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;112;1635.33,-876.5028;Float;False;Property;_VertexColorStrenth;VertexColorStrenth;16;0;Create;True;0;0;0;False;0;False;1;7.19;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;124;1988.933,-1216.887;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;117;1990.233,-964.6873;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;141;971.9734,-837.9867;Float;False;Property;_RedMultiplayer;RedMultiplayer;2;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;132;1998.242,-477.7973;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;113;876.5543,-1220.136;Inherit;True;Property;_RedTexture;RedTexture;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;127;1661.053,-703.0063;Float;False;Property;_RedOpacity;RedOpacity;3;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;32;319.2034,-471.3975;Float;False;Property;_EmissionSwitch;EmissionSwitch;20;0;Create;True;0;0;0;False;0;False;0;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;142;514.6033,613.8568;Inherit;True;Property;_RedNormals;RedNormals;17;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;140;1167.453,-897.7175;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleAddOpNode;74;891.655,-985.1011;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.PowerNode;133;2251.643,-492.2761;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;128;944.8245,-485.0371;Inherit;True;Property;_BlueTexture;BlueTexture;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;138;1009.983,-275.0761;Float;False;Property;_BlueMultiplayer;BlueMultiplayer;6;0;Create;True;0;0;0;False;0;False;1;2.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;135;2029.013,-162.8565;Float;False;Property;_BlueOpacity;BlueOpacity;7;0;Create;True;0;0;0;False;0;False;1;0.35;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;126;1922.633,-672.1864;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;134;2343.952,-224.3965;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;146;4;7;0
WireConnection;146;6;37;0
WireConnection;146;7;10;0
ASEEND*/
//CHKSM=F4B2C20EDFFC0DB06BCF666CFC2231918F95B2DA