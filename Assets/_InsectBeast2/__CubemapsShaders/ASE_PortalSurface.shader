...
Shader "ASE/ASE_PortalSurface"
{
	Properties
	{
		...
		[ASEBegin]_TransperencyMask("TransperencyMask", 2D) = "white" {}
		...
		[ASEEnd]_Height2("Height2", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 panner125 = ( 1.0 * _Time.y * float2( 0.11,0 ) + texCoord17);
				float2 panner126 = ( 1.0 * _Time.y * float2( 0,0.1 ) + texCoord17);
				...
				float2 Offset121 = ( ( ( tex2D( _Height1, panner125 ).r * tex2D( _Height2, panner126 ).r ) - 1 ) * ase_tanViewDir.xy * ( 0.001 * _ParalaxOffset ) ) + texCoord17;
				float4 temp_output_3_0 = ( tex2D( _Albedo, Offset121 ) * _AlbedoColor );
				
				float3 unpack13 = UnpackNormalScale( tex2D( _NormalMap, Offset121 ), _NormalMapDepth );
				unpack13.z = lerp( 1, unpack13.z, saturate(_NormalMapDepth) );
				
				float4 tex2DNode5 = tex2D( _MetallicMap, Offset121 );
				...
				float3 linearToGamma103 = FastLinearToSRGB( tex2D( _SmoothnessMap, Offset121 ).rgb );
				
				float2 uv_TransperencyMask = packedInput.ase_texcoord5.xy * _TransperencyMask_ST.xy + _TransperencyMask_ST.zw;
				...
				surfaceDescription.Alpha = tex2D( _TransperencyMask, uv_TransperencyMask ).a;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 temp_cast_0 = (_Tiling).xx;
				float2 texCoord17 = packedInput.ase_texcoord2.xy * temp_cast_0 + float2( 0,0 );
				float2 panner125 = ( 1.0 * _Time.y * float2( 0.11,0 ) + texCoord17);
				float2 panner126 = ( 1.0 * _Time.y * float2( 0,0.1 ) + texCoord17);
				...
				float2 uv_TransperencyMask = packedInput.ase_texcoord2.xy * _TransperencyMask_ST.xy + _TransperencyMask_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_TransperencyMask = packedInput.ase_texcoord1.xy * _TransperencyMask_ST.xy + _TransperencyMask_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_TransperencyMask = packedInput.ase_texcoord3.xy * _TransperencyMask_ST.xy + _TransperencyMask_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_TransperencyMask = packedInput.ase_texcoord7.xy * _TransperencyMask_ST.xy + _TransperencyMask_ST.zw;
...
Node;AmplifyShaderEditor.SamplerNode;122;-2634.481,-1026.653;Inherit;True;Property;_Height1;Height1;18;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;123;-2635.273,-833.694;Inherit;True;Property;_Height2;Height2;19;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;118;239.6592,-130.7016;Inherit;True;Property;_TransperencyMask;TransperencyMask;0;0;Create;True;0;0;0;False;0;False;-1;None;75f900c6783cb514cb994ee389ef49b6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;107;1165.502,-341.0357;Float;False;True;-1;2;Rendering.HighDefinition.LitShaderGraphGUI;0;12;ASE/ASE_PortalSurface;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;34;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps5;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_ZWrite;False;True;True;True;True;True;0;True;_LightLayersMaskBuffer4;False;False;False;False;False;False;False;True;True;0;True;_StencilWriteMaskGBuffer;255;False;;255;True;_StencilWriteMaskDistortionVec;7;False;;3;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;False;True;0;True;_StencilRefGBuffer;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;39;Surface Type;1;0;  Rendering Pass;1;0;  Refraction Model;0;0;    Blending Mode;0;0;    Blend Preserves Specular;1;0;  Back Then Front Rendering;0;0;  Transparent Depth Prepass;0;0;  Transparent Depth Postpass;0;0;  ZWrite;0;0;  Z Test;4;0;Double-Sided;0;0;Alpha Clipping;0;0;  Use Shadow Threshold;0;0;Material Type,InvertActionOnDeselection;0;0;  Energy Conserving Specular;1;0;  Transmission,InvertActionOnDeselection;0;0;Forward Only;0;0;Receive Decals;0;0;Receives SSR;1;0;Receive SSR Transparent;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Specular AA;0;0;Specular Occlusion Mode;1;0;Override Baked GI;0;0;Depth Offset;0;0;DOTS Instancing;0;0;GPU Instancing;1;0;LOD CrossFade;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position;1;0;0;11;True;True;True;True;True;True;False;False;False;True;True;False;;False;0
...
WireConnection;107;9;118;4
ASEEND*/
//CHKSM=5F275148671B7DCE359F3F194708A52191AB14D1